 ...
 * Generated at: 2018-01-03 12:27:14 UTC
...
public final class show_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("           \t\t \t<img src=\"images/map1.png\" alt=\"散点图\" />\r\n");
      out.write("           \t\t \t<h4>1.在输入框输入1-10的数字，点击生成节点按钮，上图将自动生成散点图</h4>\r\n");
      out.write("           \t\t \t<h4>2.在开始的节点和结束的节点有两个下拉框，可以根据你的意愿，惊醒点的选取</h4>\r\n");
      out.write("           \t\t \t<h4>3.选后点后，点击开始按钮，路由表就会出现，就如上图所示</h4>\r\n");
      out.write("           \t\t \t<h4>4.点击下一步，系统会找到最大权值，进行减操作，直到生成最大权值的路径为止</h4>\r\n");
      out.write("           \t\t \t<img src=\"images/map2.png\" alt=\"权值减操作\" width=\"720px\" height=\"331px\"/>\r\n");
      out.write("           \t\t \t<img src=\"images/map3.png\" alt=\"权值减操作\" />\r\n");
      out.write("           \t\t \t<img src=\"images/map4.png\" alt=\"权值减操作\" />\r\n");
      out.write("           \t\t \t<img src=\"images/map5.png\" alt=\"权值减操作\" />\r\n");
      out.write("           \t\t \t<h4 style=\"margin-top: 40px;\">最后的结果是：</h4>\r\n");
      out.write("           \t\t \t<img src=\"images/map6.png\" alt=\"最后的结果\" />\r\n");
      out.write("           \t\t </div>\r\n");
      out.write("        \t</div>\r\n");
      out.write("\t</div> \r\n");
